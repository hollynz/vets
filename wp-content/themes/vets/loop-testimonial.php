...
// WRAPPER
echo "<div class=\"slide grid-container slide{$slide_count} testimonial_rotator_slide hreview itemreviewed item {$has_image} cf-tr\">\n";		
...
if( $show_body )
{
    ...
    echo "<div class=\"vets-home-testimonial-quote\">\n";
...
{
	echo "<div class=\"vets-home-testimonial-author-info cf-tr\">\n";
	echo wpautop($cite);
	echo "</div>\n";				
}
